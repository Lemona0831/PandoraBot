    ...
    public class HelpModule : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        private static Embed BuildPlayerHelp()
        {
            return new EmbedBuilder()
                ...
                .AddField("/내정보", "현재 선택 캐릭터, 보유 캐릭터, 최근 판정을 한 번에 확인합니다.")
                .AddField("/검수상태", "내가 등록한 캐릭터들의 승인/대기/반려 상태를 확인합니다.")
        ...
        private static Embed BuildAdminHelp()
        {
            return new EmbedBuilder()
                ...
                .AddField("/관리목록 / /관리정보", "캐릭터명 기준으로 등록 캐릭터 목록과 상세 정보를 조회합니다.")
                .AddField("/피해 / /회복 / /관리체력", "캐릭터명만 입력해 HP를 빠르게 조정하고 관리 로그에 기록합니다.")
